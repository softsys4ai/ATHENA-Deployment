...
#python ensemble.py --video 0 TF_XLA_FLAGS="--tf_xla_auto_jit=2 --tf_xla_cpu_global_jit"
...
#python ensemble.py --video 0 --tf_xla_auto_jit=2 --tf_xla_cpu_global_jit
#TF_XLA_FLAGS="--tf_xla_auto_jit=2 --tf_xla_cpu_global_jit" ensemble.py
#python ensemble.py TF_XLA_FLAGS=--tf_xla_cpu_global_jit