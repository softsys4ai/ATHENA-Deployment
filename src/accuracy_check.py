...
flags.DEFINE_string('weights', './checkpoints/yolov3_salt/yolov3_salt_3.tf',
...
def main(_argv):
    ...
    yolo.load_weights('./checkpoints/yolov3_salt/yolov3_salt_8.tf')  #'./checkpoints/yolov3_clean/yolov3_clean.tf')
