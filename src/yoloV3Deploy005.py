...
def load_image_pixels(image, shape):
    ...
    original = tf.convert_to_tensor(image)
...
if __name__ == "__main__":
    ...
    # load yolov3 model
    model = load_model('yolov3-grey.h5')
    # define the expected input shape for the model
    #input_w, input_h = 416, 312
    ...
    while True:
        ...
        for i in range(len(v_boxes)):
            ...
            fps = 1 / (new_frame_time - prev_frame_time + 0.00000000000000001)
            ...
            #display the fps
            frame = cv2.putText(frame, fps, (10, 20), font, fontScale, color,
