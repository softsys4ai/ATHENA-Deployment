...
flags.DEFINE_float('accuracy', 0.95, 'what is the minimum iou')
flags.DEFINE_integer('num_classes', 80, 'number of classes in the model')
flags.DEFINE_integer('gpu', None, 'set which gpu to use')
flags.DEFINE_boolean('show_img', False, 'controals weather or not images are shown')
